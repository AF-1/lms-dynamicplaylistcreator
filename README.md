...
The target group for this plugin is users who want to quickly and easily create custom dynamic playlists in a browser using **only** templates and who do **not** want to work with raw SQLite statements. Accordingly, DPLC does not include the option to edit SQLite statements manually in the plugin (see [FAQ](#faq)).
<br clear="right">
